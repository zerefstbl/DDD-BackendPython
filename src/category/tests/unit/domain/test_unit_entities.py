...
class TestCategory(unittest.TestCase):
    ...
    def test_update_category(self):
        ...
        category.update(name=expected_name, description=expected_description)
    ...
    def test_update_category_with_one_parameter_and_return_ok(self):
        expected_description = "A new Description"

        category = Category(name='Category')

        category.update(name=None, description=expected_description)
